...
├── OU=Admin
│   ├── OU=Tier0
│   │   ├── OU=Admins          # Tier 0 admin user accounts
...
New-AdsiOU -Name "Tier0" -ParentDN "OU=Admin,$domainDN"
New-AdsiOU -Name "Admins" -ParentDN "OU=Tier0,OU=Admin,$domainDN"
New-AdsiOU -Name "ServiceAccounts" -ParentDN "OU=Tier0,OU=Admin,$domainDN"
New-AdsiOU -Name "Groups" -ParentDN "OU=Tier0,OU=Admin,$domainDN"
...
$groupsOU = "OU=Groups,OU=Tier0,OU=Admin,$domainDN"
...
```json
{
  ...
  "Tier0": {
    "Enabled": true,
    "AdminOUs": [
      "OU=Admins,OU=Tier0,OU=Admin,DC=contoso,DC=com"
    ],
    "ServiceAccountOUs": [
      "OU=ServiceAccounts,OU=Tier0,OU=Admin,DC=contoso,DC=com"
    ],
    "ComputerOUs": [
...
$groupDN = "CN=TG-Tier0-RestrictionGroup,OU=Groups,OU=Tier0,OU=Admin,DC=contoso,DC=com"
...
Set-AdsiAuthenticationPolicy `
    -UserDN "CN=PilotAdmin,OU=Admins,OU=Tier0,OU=Admin,DC=contoso,DC=com" `
...
```powershell
Remove-AdsiAuthenticationPolicy -UserDN "CN=Admin,OU=Admins,OU=Tier0,OU=Admin,DC=contoso,DC=com"
```
...
Remove-AdsiGroupMember -GroupDN $protectedUsersGroup.distinguishedName -MemberDN "CN=Admin,OU=Admins,OU=Tier0,OU=Admin,DC=contoso,DC=com"
```
